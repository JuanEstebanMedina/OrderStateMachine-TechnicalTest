...
import { formatOrderEvent } from '../utils/format';
import type { ApplyOrderEventRequest, OrderMetadata } from '../types/order';
...
export function EventForm({
  ...
  if (isDisabled) {
    return (
      <section className="panel event-panel" aria-labelledby="event-form-title">
